...
#ifndef DOGECHAT_PLUGIN_API_H
#define DOGECHAT_PLUGIN_API_H 1
...
/* strings */
extern void plugin_api_charset_set (struct t_dogechat_plugin *plugin,
                                    const char *charset);
...
extern const char *plugin_api_config_get_plugin (struct t_dogechat_plugin *plugin,
                                           const char *option_name);
extern int plugin_api_config_is_set_plugin (struct t_dogechat_plugin *plugin,
                                            const char *option_name);
extern int plugin_api_config_set_plugin (struct t_dogechat_plugin *plugin,
                                         const char *option_name,
                                         const char *value);
extern void plugin_api_config_set_desc_plugin (struct t_dogechat_plugin *plugin,
                                               const char *option_name,
                                               const char *description);
extern int plugin_api_config_unset_plugin (struct t_dogechat_plugin *plugin,
                                           const char *option_name);
...
/* command */
extern int plugin_api_command (struct t_dogechat_plugin *plugin,
