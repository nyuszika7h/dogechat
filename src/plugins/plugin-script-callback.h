...
#ifndef DOGECHAT_PLUGIN_SCRIPT_CALLBACK_H
#define DOGECHAT_PLUGIN_SCRIPT_CALLBACK_H 1
...
extern void plugin_script_callback_print_log (struct t_dogechat_plugin *dogechat_plugin,
                                              struct t_plugin_script_cb *script_callback);

#endif /* DOGECHAT_PLUGIN_SCRIPT_CALLBACK_H */
