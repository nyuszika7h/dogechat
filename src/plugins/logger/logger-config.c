                                  ...
                                  struct t_config_option *option)
{
    ...
    if (dogechat_config_integer (logger_config_file_flush_delay) > 0)
    {
        if (dogechat_logger_plugin->debug)
        {
            dogechat_printf_tags (NULL,
                                 ...
                                 LOGGER_PLUGIN_NAME,
                                 dogechat_config_integer (logger_config_file_flush_delay));
        }
        logger_timer = dogechat_hook_timer (dogechat_config_integer (logger_config_file_flush_delay) * 1000,
                                           0, 0,
...
{
    return dogechat_config_search_option (logger_config_file,
...
logger_config_init ()
{
    ...
    logger_config_file = dogechat_config_new (LOGGER_CONFIG_NAME,
                                             NULL, NULL);
    if (!logger_config_file)
        return 0;

    /* look */
    ptr_section = dogechat_config_new_section (logger_config_file, "look",
                                              0, 0,
                                              NULL, NULL, NULL, NULL,
                                              NULL, NULL, NULL, NULL,
                                              NULL, NULL);
    if (!ptr_section)
    {
        dogechat_config_free (logger_config_file);
        return 0;
    }

    logger_config_look_backlog = dogechat_config_new_option (
    ...
    /* color */
    ptr_section = dogechat_config_new_section (logger_config_file, "color",
                                              0, 0,
                                              NULL, NULL, NULL, NULL,
                                              NULL, NULL, NULL, NULL,
                                              NULL, NULL);
    ...
    logger_config_color_backlog_end = dogechat_config_new_option (
        logger_config_file, ptr_section,
        "backlog_end", "color",
        N_("color for line ending the backlog"),
        NULL, -1, 0, "default", NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL);
    logger_config_color_backlog_line = dogechat_config_new_option (
        logger_config_file, ptr_section,
        "backlog_line", "color",
    ...
    /* file */
    ptr_section = dogechat_config_new_section (logger_config_file, "file",
                                              0, 0,
                                              NULL, NULL, NULL, NULL,
                                              NULL, NULL, NULL, NULL,
                                              NULL, NULL);
    ...
    logger_config_file_auto_log = dogechat_config_new_option (
        logger_config_file, ptr_section,
        "auto_log", "boolean",
        N_("automatically save content of buffers to files (unless a buffer "
           "disables log)"),
        NULL, 0, 0, "on", NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL);
    logger_config_file_flush_delay = dogechat_config_new_option (
        logger_config_file, ptr_section,
        "flush_delay", "integer",
    ...
    logger_config_file_info_lines = dogechat_config_new_option (
        logger_config_file, ptr_section,
        "info_lines", "boolean",
        N_("write information line in log file when log starts or ends for a "
           "buffer"),
        NULL, 0, 0, "off", NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL);
    logger_config_file_mask = dogechat_config_new_option (
        logger_config_file, ptr_section,
        "mask", "string",
        N_("default file name mask for log files (format is "
           ...
           "(see man strftime)"),
        NULL, 0, 0, "$plugin.$name.dogechatlog", NULL, 0, NULL, NULL,
        &logger_config_change_file_option_restart_log, NULL, NULL, NULL);
    logger_config_file_name_lower_case = dogechat_config_new_option (
        logger_config_file, ptr_section,
        "name_lower_case", "boolean",
        N_("use only lower case for log filenames"),
        NULL, 0, 0, "on", NULL, 0, NULL, NULL,
        &logger_config_change_file_option_restart_log, NULL, NULL, NULL);
    logger_config_file_nick_prefix = dogechat_config_new_option (
        logger_config_file, ptr_section,
        "nick_prefix", "string",
        N_("text to write before nick in prefix of message, example: \"<\""),
        NULL, 0, 0, "", NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL);
    logger_config_file_nick_suffix = dogechat_config_new_option (
        logger_config_file, ptr_section,
        "nick_suffix", "string",
        N_("text to write after nick in prefix of message, example: \">\""),
        NULL, 0, 0, "", NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL);
    logger_config_file_path = dogechat_config_new_option (
        logger_config_file, ptr_section,
        "path", "string",
        N_("path for DogeChat log files; \"%h\" at beginning of string is "
           "replaced by DogeChat home (\"~/.dogechat\" by default); date "
           "specifiers are permitted (see man strftime) "
           "(note: content is evaluated, see /help eval)"),
        NULL, 0, 0, "%h/logs/", NULL, 0, NULL, NULL,
        &logger_config_change_file_option_restart_log, NULL, NULL, NULL);
    logger_config_file_replacement_char = dogechat_config_new_option (
        logger_config_file, ptr_section,
        ...
        &logger_config_change_file_option_restart_log, NULL, NULL, NULL);
    logger_config_file_time_format = dogechat_config_new_option (
        logger_config_file, ptr_section,
        "time_format", "string",
    ...
    /* level */
    ptr_section = dogechat_config_new_section (logger_config_file, "level",
                                              1, 1,
                                              NULL, NULL, NULL, NULL,
                                              NULL, NULL,
    ...
    /* mask */
    ptr_section = dogechat_config_new_section (logger_config_file, "mask",
                                              1, 1,
                                              NULL, NULL, NULL, NULL,
                                              NULL, NULL,
...
logger_config_read ()
{
    ...
    rc = dogechat_config_read (logger_config_file);
...
logger_config_write ()
{
    return dogechat_config_write (logger_config_file);
}
