...
#ifndef DOGECHAT_EXEC_H
#define DOGECHAT_EXEC_H 1

#include <time.h>

#define dogechat_plugin dogechat_exec_plugin
...
extern struct t_dogechat_plugin *dogechat_exec_plugin;
