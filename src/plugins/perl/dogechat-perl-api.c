/*
 * dogechat-perl-api.c - perl API functions
 *
...
#define API_DEF_FUNC(__name)                                           \
    newXS ("dogechat::" #__name, XS_dogechat_api_##__name, "dogechat");
#define API_FUNC(__name)                                                \
    XS (XS_dogechat_api_##__name)
#define API_INIT_FUNC(__init, __name, __ret)                            \
    ...
    {                                                                   \
        DOGECHAT_SCRIPT_MSG_NOT_INIT(PERL_CURRENT_SCRIPT_NAME,           \
                                    perl_function_name);                \
        __ret;                                                          \
    }
#define API_WRONG_ARGS(__ret)                                           \
    {                                                                   \
        DOGECHAT_SCRIPT_MSG_WRONG_ARGS(PERL_CURRENT_SCRIPT_NAME,         \
                                      perl_function_name);              \
        __ret;                                                          \
    }
...
#define API_STR2PTR(__string)                                           \
    plugin_script_str2ptr (dogechat_perl_plugin,                         \
...
API_FUNC(register)
{
    ...
    if (plugin_script_search (dogechat_perl_plugin, perl_scripts, name))
    {
    ...
    /* register script */
    perl_current_script = plugin_script_add (dogechat_perl_plugin,
...
API_FUNC(plugin_get_name)
{
    ...
    result = dogechat_plugin_get_name (API_STR2PTR(SvPV_nolen (ST (0)))); /* plugin */
...
API_FUNC(gettext)
{
    ...
    result = dogechat_gettext (SvPV_nolen (ST (0))); /* string */
...
API_FUNC(ngettext)
{
    ...
    result = dogechat_ngettext (single, plural,
                               SvIV (ST (2))); /* count */
...
API_FUNC(strlen_screen)
{
    ...
    value = dogechat_strlen_screen (SvPV_nolen (ST (0))); /* string */
...
API_FUNC(string_match)
{
    ...
    value = dogechat_string_match (SvPV_nolen (ST (0)), /* string */
...
API_FUNC(string_has_highlight)
{
    ...
    value = dogechat_string_has_highlight (SvPV_nolen (ST (0)), /* string */
...
API_FUNC(string_has_highlight_regex)
{
    ...
    value = dogechat_string_has_highlight_regex (SvPV_nolen (ST (0)), /* string */
...
API_FUNC(string_mask_to_regex)
{
    ...
    result = dogechat_string_mask_to_regex (SvPV_nolen (ST (0))); /* mask */
...
API_FUNC(string_is_command_char)
{
    ...
    value = dogechat_string_is_command_char (SvPV_nolen (ST (0))); /* string */
...
API_FUNC(string_input_for_buffer)
{
    ...
    result = dogechat_string_input_for_buffer (SvPV_nolen (ST (0))); /* string */
...
API_FUNC(string_eval_expression)
{
    ...
    pointers = dogechat_perl_hash_to_hashtable (ST (1),
                                               DOGECHAT_SCRIPT_HASHTABLE_DEFAULT_SIZE,
                                               DOGECHAT_HASHTABLE_STRING,
                                               DOGECHAT_HASHTABLE_POINTER);
    extra_vars = dogechat_perl_hash_to_hashtable (ST (2),
                                                 DOGECHAT_SCRIPT_HASHTABLE_DEFAULT_SIZE,
                                                 DOGECHAT_HASHTABLE_STRING,
                                                 DOGECHAT_HASHTABLE_STRING);
    options = dogechat_perl_hash_to_hashtable (ST (3),
                                              DOGECHAT_SCRIPT_HASHTABLE_DEFAULT_SIZE,
                                              DOGECHAT_HASHTABLE_STRING,
                                              DOGECHAT_HASHTABLE_STRING);
...
API_FUNC(mkdir_home)
{
    ...
    if (dogechat_mkdir_home (SvPV_nolen (ST (0)), /* directory */
                            SvIV (ST (1)))) /* mode */
        API_RETURN_OK;
...
API_FUNC(mkdir)
{
    ...
    if (dogechat_mkdir (SvPV_nolen (ST (0)), /* directory */
                       SvIV (ST (1)))) /* mode */
        API_RETURN_OK;
...
API_FUNC(mkdir_parents)
{
    ...
    if (dogechat_mkdir_parents (SvPV_nolen (ST (0)), /* directory */
                               SvIV (ST (1)))) /* mode */
        API_RETURN_OK;
...
API_FUNC(list_get)
{
    ...
    result = API_PTR2STR(dogechat_list_get (API_STR2PTR(SvPV_nolen (ST (0))), /* dogelist */
                                           SvIV (ST (1)))); /* position */
...
API_FUNC(list_next)
{
    ...
    result = API_PTR2STR(dogechat_list_next (API_STR2PTR(SvPV_nolen (ST (0))))); /* item */
...
API_FUNC(list_prev)
{
    ...
    result = API_PTR2STR(dogechat_list_prev (API_STR2PTR(SvPV_nolen (ST (0))))); /* item */
...
API_FUNC(list_string)
{
    ...
    result = dogechat_list_string (API_STR2PTR(SvPV_nolen (ST (0)))); /* item */
...
API_FUNC(list_size)
{
    ...
    size = dogechat_list_size (API_STR2PTR(SvPV_nolen (ST (0)))); /* dogelist */
...
API_FUNC(list_remove_all)
{
    ...
    dogechat_list_remove_all (API_STR2PTR(SvPV_nolen (ST (0)))); /* dogelist */
...
API_FUNC(list_free)
{
    ...
    dogechat_list_free (API_STR2PTR(SvPV_nolen (ST (0)))); /* dogelist */

    API_RETURN_OK;
}

int
dogechat_perl_api_config_reload_cb (void *data,
                                   struct t_config_file *config_file)
{
    ...
    if (script_callback && script_callback->function && script_callback->function[0])
    {
        ...
        rc = (int *) dogechat_perl_exec (script_callback->script,
...
API_FUNC(config_new)
{
    ...
    result = API_PTR2STR(plugin_script_api_config_new (dogechat_perl_plugin,
                                                       perl_current_script,
                                                       name,
                                                       &dogechat_perl_api_config_reload_cb,
                                                       function,
                                                       data));
...
int
dogechat_perl_api_config_section_read_cb (void *data,
                                         struct t_config_file *config_file,
...
int
dogechat_perl_api_config_section_write_cb (void *data,
                                          struct t_config_file *config_file,
...
int
dogechat_perl_api_config_section_write_default_cb (void *data,
                                                  struct t_config_file *config_file,
                                                  const char *section_name)
{
    struct t_plugin_script_cb *script_callback;
...
int
dogechat_perl_api_config_section_create_option_cb (void *data,
                                                  struct t_config_file *config_file,
                                                  struct t_config_section *section,
                                                  const char *option_name,
                                                  const char *value)
...
int
dogechat_perl_api_config_section_delete_option_cb (void *data,
                                                  struct t_config_file *config_file,
                                                  struct t_config_section *section,
...
API_FUNC(config_new_section)
{
    ...
    result = API_PTR2STR(plugin_script_api_config_new_section (dogechat_perl_plugin,
                                                               perl_current_script,
                                                               API_STR2PTR(cfg_file),
                                                               name,
                                                               SvIV (ST (2)), /* user_can_add_options */
                                                               SvIV (ST (3)), /* user_can_delete_options */
                                                               &dogechat_perl_api_config_section_read_cb,
                                                               function_read,
                                                               data_read,
                                                               &dogechat_perl_api_config_section_write_cb,
                                                               function_write,
                                                               data_write,
                                                               &dogechat_perl_api_config_section_write_default_cb,
                                                               function_write_default,
                                                               data_write_default,
                                                               &dogechat_perl_api_config_section_create_option_cb,
                                                               function_create_option,
                                                               data_create_option,
                                                               &dogechat_perl_api_config_section_delete_option_cb,
...
int
dogechat_perl_api_config_option_check_value_cb (void *data,
                                               struct t_config_option *option,
                                               const char *value)
{
    struct t_plugin_script_cb *script_callback;
...
void
dogechat_perl_api_config_option_change_cb (void *data,
                                          struct t_config_option *option)
{
    struct t_plugin_script_cb *script_callback;
    void *func_argv[2];
...
void
dogechat_perl_api_config_option_delete_cb (void *data,
                                          struct t_config_option *option)
{
    struct t_plugin_script_cb *script_callback;
    void *func_argv[2];
...
API_FUNC(config_new_option)
{
    ...
    result = API_PTR2STR(plugin_script_api_config_new_option (dogechat_perl_plugin,
                                                              perl_current_script,
                                                              ...
                                                              &dogechat_perl_api_config_option_check_value_cb,
                                                              function_check_value,
                                                              data_check_value,
                                                              &dogechat_perl_api_config_option_change_cb,
                                                              function_change,
                                                              data_change,
                                                              &dogechat_perl_api_config_option_delete_cb,
                                                              function_delete,
                                                              data_delete));
...
API_FUNC(config_string_to_boolean)
{
    ...
    value = dogechat_config_string_to_boolean (SvPV_nolen (ST (0))); /* text */
...
API_FUNC(config_option_is_null)
{
    ...
    value = dogechat_config_option_is_null (API_STR2PTR(SvPV_nolen (ST (0)))); /* option */
...
API_FUNC(config_option_default_is_null)
{
    ...
    value = dogechat_config_option_default_is_null (API_STR2PTR(SvPV_nolen (ST (0)))); /* option */
...
API_FUNC(config_boolean)
{
    ...
    value = dogechat_config_boolean (API_STR2PTR(SvPV_nolen (ST (0)))); /* option */
...
API_FUNC(config_boolean_default)
{
    ...
    value = dogechat_config_boolean_default (API_STR2PTR(SvPV_nolen (ST (0)))); /* option */
...
API_FUNC(config_integer)
{
    ...
    value = dogechat_config_integer (API_STR2PTR(SvPV_nolen (ST (0)))); /* option */
...
API_FUNC(config_integer_default)
{
    ...
    value = dogechat_config_integer_default (API_STR2PTR(SvPV_nolen (ST (0)))); /* option */
...
API_FUNC(config_string)
{
    ...
    result = dogechat_config_string (API_STR2PTR(SvPV_nolen (ST (0)))); /* option */
...
API_FUNC(config_string_default)
{
    ...
    result = dogechat_config_string_default (API_STR2PTR(SvPV_nolen (ST (0)))); /* option */
...
API_FUNC(config_color)
{
    ...
    result = dogechat_config_color (API_STR2PTR(SvPV_nolen (ST (0)))); /* option */
...
API_FUNC(config_color_default)
{
    ...
    result = dogechat_config_color_default (API_STR2PTR(SvPV_nolen (ST (0)))); /* option */
...
API_FUNC(config_write)
{
    ...
    rc = dogechat_config_write (API_STR2PTR(SvPV_nolen (ST (0)))); /* config_file */
...
API_FUNC(config_read)
{
    ...
    rc = dogechat_config_read (API_STR2PTR(SvPV_nolen (ST (0)))); /* config_file */
...
API_FUNC(config_reload)
{
    ...
    rc = dogechat_config_reload (API_STR2PTR(SvPV_nolen (ST (0)))); /* config_file */
...
API_FUNC(config_option_free)
{
    ...
    plugin_script_api_config_option_free (dogechat_perl_plugin,
                                          perl_current_script,
...
API_FUNC(config_section_free_options)
{
    ...
    plugin_script_api_config_section_free_options (dogechat_perl_plugin,
                                                   perl_current_script,
...
API_FUNC(config_section_free)
{
    ...
    plugin_script_api_config_section_free (dogechat_perl_plugin,
                                           perl_current_script,
                                           API_STR2PTR(SvPV_nolen (ST (0)))); /* section */
...
API_FUNC(config_free)
{
    ...
    plugin_script_api_config_free (dogechat_perl_plugin,
                                   perl_current_script,
...
API_FUNC(config_get)
{
    ...
    result = API_PTR2STR(dogechat_config_get (SvPV_nolen (ST (0))));
...
API_FUNC(config_get_plugin)
{
    ...
    result = plugin_script_api_config_get_plugin (dogechat_perl_plugin,
                                                  perl_current_script,
                                                  SvPV_nolen (ST (0)));
...
API_FUNC(config_is_set_plugin)
{
    ...
    rc = plugin_script_api_config_is_set_plugin (dogechat_perl_plugin,
                                                 perl_current_script,
                                                 option);
...
API_FUNC(config_set_plugin)
{
    ...
    rc = plugin_script_api_config_set_plugin (dogechat_perl_plugin,
                                              perl_current_script,
                                              option,
                                              value);
...
API_FUNC(config_set_desc_plugin)
{
    ...
    plugin_script_api_config_set_desc_plugin (dogechat_perl_plugin,
                                              perl_current_script,
                                              option,
                                              description);
...
API_FUNC(config_unset_plugin)
{
    ...
    rc = plugin_script_api_config_unset_plugin (dogechat_perl_plugin,
                                                perl_current_script,
                                                option);
...
API_FUNC(key_bind)
{
    ...
    hashtable = dogechat_perl_hash_to_hashtable (ST (1),
                                                DOGECHAT_SCRIPT_HASHTABLE_DEFAULT_SIZE,
                                                DOGECHAT_HASHTABLE_STRING,
                                                DOGECHAT_HASHTABLE_STRING);
...
API_FUNC(prefix)
{
    ...
    result = dogechat_prefix (SvPV_nolen (ST (0))); /* prefix */
...
API_FUNC(color)
{
    ...
    result = dogechat_color (SvPV_nolen (ST (0))); /* color */
...
API_FUNC(print)
{
    ...
    plugin_script_api_printf (dogechat_perl_plugin,
                              perl_current_script,
                              API_STR2PTR(buffer),
                              "%s", message);
...
API_FUNC(print_date_tags)
{
    ...
    plugin_script_api_printf_date_tags (dogechat_perl_plugin,
                                        perl_current_script,
                                        API_STR2PTR(buffer),
                                        SvIV (ST (1)),
                                        tags,
...
API_FUNC(print_y)
{
    ...
    plugin_script_api_printf_y (dogechat_perl_plugin,
                                perl_current_script,
                                API_STR2PTR(buffer),
                                SvIV (ST (1)),
                                "%s", message);
...
API_FUNC(log_print)
{
    ...
    plugin_script_api_log_printf (dogechat_perl_plugin,
                                  perl_current_script,
...
int
dogechat_perl_api_hook_command_cb (void *data, struct t_gui_buffer *buffer,
...
API_FUNC(hook_command)
{
    ...
    result = API_PTR2STR(plugin_script_api_hook_command (dogechat_perl_plugin,
                                                         perl_current_script,
                                                         command,
                                                         description,
                                                         args,
                                                         args_description,
                                                         completion,
                                                         &dogechat_perl_api_hook_command_cb,
                                                         function,
                                                         data));
...
int
dogechat_perl_api_hook_command_run_cb (void *data, struct t_gui_buffer *buffer,
                                      const char *command)
{
    struct t_plugin_script_cb *script_callback;
    void *func_argv[3];
...
API_FUNC(hook_command_run)
{
    ...
    result = API_PTR2STR(plugin_script_api_hook_command_run (dogechat_perl_plugin,
                                                             perl_current_script,
                                                             command,
                                                             &dogechat_perl_api_hook_command_run_cb,
                                                             function,
                                                             data));
...
int
dogechat_perl_api_hook_timer_cb (void *data, int remaining_calls)
{
    struct t_plugin_script_cb *script_callback;
    void *func_argv[2];
...
API_FUNC(hook_timer)
{
    ...
    result = API_PTR2STR(plugin_script_api_hook_timer (dogechat_perl_plugin,
                                                       perl_current_script,
                                                       SvIV (ST (0)), /* interval */
                                                       SvIV (ST (1)), /* align_second */
                                                       SvIV (ST (2)), /* max_calls */
                                                       &dogechat_perl_api_hook_timer_cb,
...
int
dogechat_perl_api_hook_fd_cb (void *data, int fd)
{
    struct t_plugin_script_cb *script_callback;
    void *func_argv[2];
...
API_FUNC(hook_fd)
{
    ...
    result = API_PTR2STR(plugin_script_api_hook_fd (dogechat_perl_plugin,
                                                    perl_current_script,
                                                    SvIV (ST (0)), /* fd */
                                                    SvIV (ST (1)), /* read */
                                                    SvIV (ST (2)), /* write */
                                                    SvIV (ST (3)), /* exception */
                                                    &dogechat_perl_api_hook_fd_cb,
...
int
dogechat_perl_api_hook_process_cb (void *data,
...
API_FUNC(hook_process)
{
    ...
    result = API_PTR2STR(plugin_script_api_hook_process (dogechat_perl_plugin,
                                                         perl_current_script,
                                                         command,
                                                         SvIV (ST (1)), /* timeout */
                                                         &dogechat_perl_api_hook_process_cb,
                                                         function,
                                                         data));
...
API_FUNC(hook_process_hashtable)
{
    ...
    command = SvPV_nolen (ST (0));
    options = dogechat_perl_hash_to_hashtable (ST (1),
                                              DOGECHAT_SCRIPT_HASHTABLE_DEFAULT_SIZE,
                                              DOGECHAT_HASHTABLE_STRING,
                                              DOGECHAT_HASHTABLE_STRING);
    ...
    result = API_PTR2STR(plugin_script_api_hook_process_hashtable (dogechat_perl_plugin,
                                                                   perl_current_script,
                                                                   command,
                                                                   options,
                                                                   SvIV (ST (2)), /* timeout */
...
int
dogechat_perl_api_hook_connect_cb (void *data, int status, int gnutls_rc,
...
API_FUNC(hook_connect)
{
    ...
    result = API_PTR2STR(plugin_script_api_hook_connect (dogechat_perl_plugin,
                                                         perl_current_script,
                                                         proxy,
                                                         address,
                                                         SvIV (ST (2)), /* port */
                                                         ...
                                                         local_hostname,
                                                         &dogechat_perl_api_hook_connect_cb,
                                                         function,
                                                         data));
...
int
dogechat_perl_api_hook_print_cb (void *data, struct t_gui_buffer *buffer,
                                time_t date,
...
API_FUNC(hook_print)
{
    ...
    result = API_PTR2STR(plugin_script_api_hook_print (dogechat_perl_plugin,
                                                       perl_current_script,
                                                       API_STR2PTR(buffer),
                                                       tags,
                                                       message,
                                                       SvIV (ST (3)), /* strip_colors */
                                                       &dogechat_perl_api_hook_print_cb,
                                                       function,
                                                       data));
...
int
dogechat_perl_api_hook_signal_cb (void *data, const char *signal, const char *type_data,
                                 void *signal_data)
{
    struct t_plugin_script_cb *script_callback;
    void *func_argv[3];
...
API_FUNC(hook_signal)
{
    ...
    result = API_PTR2STR(plugin_script_api_hook_signal (dogechat_perl_plugin,
                                                        perl_current_script,
                                                        signal,
                                                        &dogechat_perl_api_hook_signal_cb,
                                                        function,
                                                        data));
...
int
dogechat_perl_api_hook_hsignal_cb (void *data, const char *signal,
                                  struct t_hashtable *hashtable)
{
    struct t_plugin_script_cb *script_callback;
    void *func_argv[3];
...
API_FUNC(hook_hsignal)
{
    ...
    result = API_PTR2STR(plugin_script_api_hook_hsignal (dogechat_perl_plugin,
                                                         perl_current_script,
                                                         signal,
                                                         &dogechat_perl_api_hook_hsignal_cb,
                                                         function,
                                                         data));
...
int
dogechat_perl_api_hook_config_cb (void *data, const char *option, const char *value)
{
    struct t_plugin_script_cb *script_callback;
    void *func_argv[3];
    char empty_arg[1] = { '\0' };
...
API_FUNC(hook_config)
{
    ...
    result = API_PTR2STR(plugin_script_api_hook_config (dogechat_perl_plugin,
                                                        perl_current_script,
                                                        option,
                                                        &dogechat_perl_api_hook_config_cb,
                                                        function,
                                                        data));
...
int
dogechat_perl_api_hook_completion_cb (void *data, const char *completion_item,
...
API_FUNC(hook_completion)
{
    ...
    result = API_PTR2STR(plugin_script_api_hook_completion (dogechat_perl_plugin,
                                                            perl_current_script,
                                                            completion,
                                                            description,
                                                            &dogechat_perl_api_hook_completion_cb,
                                                            function,
                                                            data));
...
char *
dogechat_perl_api_hook_modifier_cb (void *data, const char *modifier,
                                   const char *modifier_data, const char *string)
{
    ...
    if (script_callback && script_callback->function && script_callback->function[0])
    {
        ...
        return (char *)dogechat_perl_exec (script_callback->script,
...
API_FUNC(hook_modifier)
{
    ...
    result = API_PTR2STR(plugin_script_api_hook_modifier (dogechat_perl_plugin,
                                                          perl_current_script,
                                                          modifier,
                                                          &dogechat_perl_api_hook_modifier_cb,
                                                          function,
                                                          data));
...
const char *
dogechat_perl_api_hook_info_cb (void *data, const char *info_name,
                               const char *arguments)
{
    ...
    if (script_callback && script_callback->function && script_callback->function[0])
    {
        ...
        return (const char *)dogechat_perl_exec (script_callback->script,
                                                DOGECHAT_SCRIPT_EXEC_STRING,
                                                script_callback->function,
                                                "sss", func_argv);
    }
...
API_FUNC(hook_info)
{
    ...
    result = API_PTR2STR(plugin_script_api_hook_info (dogechat_perl_plugin,
                                                      perl_current_script,
                                                      info_name,
                                                      description,
                                                      args_description,
                                                      &dogechat_perl_api_hook_info_cb,
                                                      function,
                                                      data));
...
struct t_hashtable *
dogechat_perl_api_hook_info_hashtable_cb (void *data, const char *info_name,
                                         struct t_hashtable *hashtable)
{
    struct t_plugin_script_cb *script_callback;
    void *func_argv[3];
    ...
    if (script_callback && script_callback->function && script_callback->function[0])
    {
        ...
        return (struct t_hashtable *)dogechat_perl_exec (script_callback->script,
...
API_FUNC(hook_info_hashtable)
{
    ...
    result = API_PTR2STR(plugin_script_api_hook_info_hashtable (dogechat_perl_plugin,
                                                                perl_current_script,
                                                                info_name,
                                                                description,
                                                                args_description,
                                                                output_description,
                                                                &dogechat_perl_api_hook_info_hashtable_cb,
                                                                function,
                                                                data));
...
struct t_infolist *
dogechat_perl_api_hook_infolist_cb (void *data, const char *infolist_name,
                                   void *pointer, const char *arguments)
{
    ...
    if (script_callback && script_callback->function && script_callback->function[0])
    {
        ...
        result = (struct t_infolist *)dogechat_perl_exec (script_callback->script,
                                                         DOGECHAT_SCRIPT_EXEC_STRING,
                                                         script_callback->function,
                                                         "ssss", func_argv);
...
API_FUNC(hook_infolist)
{
    ...
    result = API_PTR2STR(plugin_script_api_hook_infolist (dogechat_perl_plugin,
                                                          perl_current_script,
                                                          infolist_name,
                                                          description,
                                                          pointer_description,
                                                          args_description,
                                                          &dogechat_perl_api_hook_infolist_cb,
                                                          function,
                                                          data));
...
struct t_hashtable *
dogechat_perl_api_hook_focus_cb (void *data,
...
API_FUNC(hook_focus)
{
    ...
    result = API_PTR2STR(plugin_script_api_hook_focus (dogechat_perl_plugin,
                                                       perl_current_script,
                                                       area,
                                                       &dogechat_perl_api_hook_focus_cb,
                                                       function,
                                                       data));
...
API_FUNC(unhook)
{
    ...
    plugin_script_api_unhook (dogechat_perl_plugin,
                              perl_current_script,
...
API_FUNC(unhook_all)
{
    ...
    plugin_script_api_unhook_all (dogechat_perl_plugin, perl_current_script);

    API_RETURN_OK;
}

int
dogechat_perl_api_buffer_input_data_cb (void *data, struct t_gui_buffer *buffer,
...
int
dogechat_perl_api_buffer_close_cb (void *data, struct t_gui_buffer *buffer)
{
    struct t_plugin_script_cb *script_callback;
    void *func_argv[2];
    char empty_arg[1] = { '\0' };
...
API_FUNC(buffer_new)
{
    ...
    result = API_PTR2STR(plugin_script_api_buffer_new (dogechat_perl_plugin,
                                                       perl_current_script,
                                                       name,
...
API_FUNC(buffer_clear)
{
    ...
    dogechat_buffer_clear (API_STR2PTR(SvPV_nolen (ST (0)))); /* buffer */
...
API_FUNC(buffer_close)
{
    ...
    plugin_script_api_buffer_close (dogechat_perl_plugin,
                                    perl_current_script,
...
API_FUNC(buffer_merge)
{
    ...
    dogechat_buffer_merge (API_STR2PTR(SvPV_nolen (ST (0))), /* buffer */
...
API_FUNC(buffer_unmerge)
{
    ...
    dogechat_buffer_unmerge (API_STR2PTR(SvPV_nolen (ST (0))), /* buffer */
                            SvIV (ST (1))); /* number */
...
API_FUNC(buffer_get_integer)
{
    ...
    value = dogechat_buffer_get_integer (API_STR2PTR(buffer), property);
...
API_FUNC(buffer_match_list)
{
    ...
    value = dogechat_buffer_match_list (API_STR2PTR(buffer), string);
...
API_FUNC(window_search_with_buffer)
{
    ...
    result = API_PTR2STR(dogechat_window_search_with_buffer (API_STR2PTR(SvPV_nolen (ST (0)))));
...
API_FUNC(window_get_integer)
{
    ...
    value = dogechat_window_get_integer (API_STR2PTR(window), property);
...
API_FUNC(window_set_title)
{
    ...
    dogechat_window_set_title (SvPV_nolen (ST (0))); /* title */
...
API_FUNC(nicklist_remove_all)
{
    ...
    dogechat_nicklist_remove_all (API_STR2PTR(SvPV_nolen (ST (0)))); /* buffer */
...
API_FUNC(nicklist_group_get_integer)
{
    ...
    value = dogechat_nicklist_group_get_integer (API_STR2PTR(buffer),
                                                API_STR2PTR(group),
                                                property);
...
API_FUNC(nicklist_nick_get_integer)
{
    ...
    value = dogechat_nicklist_nick_get_integer (API_STR2PTR(buffer),
                                               API_STR2PTR(nick),
                                               property);
...
API_FUNC(bar_item_search)
{
    ...
    result = API_PTR2STR(dogechat_bar_item_search (SvPV_nolen (ST (0)))); /* name */

    API_RETURN_STRING_FREE(result);
}

char *
dogechat_perl_api_bar_item_build_cb (void *data, struct t_gui_bar_item *item,
                                    ...
                                    struct t_hashtable *extra_info)
{
    ...
    if (script_callback && script_callback->function && script_callback->function[0])
    {
        if (strncmp (script_callback->function, "(extra)", 7) == 0)
        {
            ...
            ret = (char *)dogechat_perl_exec (script_callback->script,
                                             DOGECHAT_SCRIPT_EXEC_STRING,
...
API_FUNC(bar_item_new)
{
    ...
    result = API_PTR2STR(plugin_script_api_bar_item_new (dogechat_perl_plugin,
                                                         perl_current_script,
                                                         name,
                                                         &dogechat_perl_api_bar_item_build_cb,
                                                         function,
                                                         data));
...
API_FUNC(bar_item_update)
{
    ...
    dogechat_bar_item_update (SvPV_nolen (ST (0))); /* name */
...
API_FUNC(bar_item_remove)
{
    ...
    plugin_script_api_bar_item_remove (dogechat_perl_plugin,
                                       perl_current_script,
...
API_FUNC(bar_search)
{
    ...
    result = API_PTR2STR(dogechat_bar_search (SvPV_nolen (ST (0)))); /* name */
...
API_FUNC(bar_update)
{
    ...
    dogechat_bar_update (SvPV_nolen (ST (0))); /* name */
...
API_FUNC(bar_remove)
{
    ...
    dogechat_bar_remove (API_STR2PTR(SvPV_nolen (ST (0)))); /* bar */
...
API_FUNC(command)
{
    ...
    rc = plugin_script_api_command (dogechat_perl_plugin,
                                    perl_current_script,
                                    API_STR2PTR(buffer),
                                    command);
...
API_FUNC(info_get)
{
    ...
    result = dogechat_info_get (info_name, arguments);
...
API_FUNC(info_get_hashtable)
{
    ...
    result_hashtable = dogechat_info_get_hashtable (info_name, hashtable);
    result_hash = dogechat_perl_hashtable_to_hash (result_hashtable);
...
API_FUNC(infolist_new_item)
{
    ...
    result = API_PTR2STR(dogechat_infolist_new_item (API_STR2PTR(infolist)));
...
API_FUNC(infolist_new_var_integer)
{
    ...
    result = API_PTR2STR(dogechat_infolist_new_var_integer (API_STR2PTR(item),
                                                           name,
                                                           SvIV (ST (2)))); /* value */
...
API_FUNC(infolist_new_var_string)
{
    ...
    result = API_PTR2STR(dogechat_infolist_new_var_string (API_STR2PTR(item),
                                                          name,
                                                          value));
...
API_FUNC(infolist_new_var_pointer)
{
    ...
    result = API_PTR2STR(dogechat_infolist_new_var_pointer (API_STR2PTR(item),
                                                           name,
                                                           API_STR2PTR(value)));
...
API_FUNC(infolist_new_var_time)
{
    ...
    result = API_PTR2STR(dogechat_infolist_new_var_time (API_STR2PTR(item),
                                                        name,
                                                        SvIV (ST (2)))); /* value */
...
API_FUNC(infolist_search_var)
{
    ...
    result = API_PTR2STR(dogechat_infolist_search_var (API_STR2PTR(infolist),
                                                      name));
...
API_FUNC(infolist_next)
{
    ...
    value = dogechat_infolist_next (API_STR2PTR(SvPV_nolen (ST (0)))); /* infolist */
...
API_FUNC(infolist_prev)
{
    ...
    value = dogechat_infolist_prev (API_STR2PTR(SvPV_nolen (ST (0)))); /* infolist */
...
API_FUNC(infolist_reset_item_cursor)
{
    ...
    dogechat_infolist_reset_item_cursor (API_STR2PTR(SvPV_nolen (ST (0)))); /* infolist */
...
API_FUNC(infolist_fields)
{
    ...
    result = dogechat_infolist_fields (API_STR2PTR(SvPV_nolen (ST (0)))); /* infolist */
...
API_FUNC(infolist_integer)
{
    ...
    value = dogechat_infolist_integer (API_STR2PTR(infolist), variable);
...
API_FUNC(infolist_free)
{
    ...
    dogechat_infolist_free (API_STR2PTR(SvPV_nolen (ST (0)))); /* infolist */
...
API_FUNC(hdata_get_var_offset)
{
    ...
    value = dogechat_hdata_get_var_offset (API_STR2PTR(hdata), name);
...
API_FUNC(hdata_get_var_array_size)
{
    ...
    value = dogechat_hdata_get_var_array_size (API_STR2PTR(hdata),
                                              API_STR2PTR(pointer),
                                              name);
...
API_FUNC(hdata_check_pointer)
{
    ...
    value = dogechat_hdata_check_pointer (API_STR2PTR(hdata),
                                         API_STR2PTR(list),
                                         API_STR2PTR(pointer));
...
API_FUNC(hdata_char)
{
    ...
    value = (int)dogechat_hdata_char (API_STR2PTR(hdata),
                                     API_STR2PTR(pointer),
                                     name);
...
API_FUNC(hdata_integer)
{
    ...
    value = dogechat_hdata_integer (API_STR2PTR(hdata),
                                   API_STR2PTR(pointer),
                                   name);
...
API_FUNC(hdata_long)
{
    ...
    value = dogechat_hdata_long (API_STR2PTR(hdata),
                                API_STR2PTR(pointer),
                                name);
...
API_FUNC(hdata_time)
{
    ...
    time = dogechat_hdata_time (API_STR2PTR(hdata), API_STR2PTR(pointer), name);
...
API_FUNC(hdata_hashtable)
{
    ...
    result_hash = dogechat_perl_hashtable_to_hash (
...
API_FUNC(hdata_update)
{
    ...
    hdata = SvPV_nolen (ST (0));
    pointer = SvPV_nolen (ST (1));
    hashtable = dogechat_perl_hash_to_hashtable (ST (2),
                                                DOGECHAT_SCRIPT_HASHTABLE_DEFAULT_SIZE,
                                                DOGECHAT_HASHTABLE_STRING,
                                                DOGECHAT_HASHTABLE_STRING);
...
API_FUNC(upgrade_new)
{
    ...
    result = API_PTR2STR(dogechat_upgrade_new (filename,
                                              SvIV (ST (1)))); /* write */
...
int
dogechat_perl_api_upgrade_read_cb (void *data,
...
API_FUNC(upgrade_read)
{
    ...
    rc = plugin_script_api_upgrade_read (dogechat_perl_plugin,
                                         perl_current_script,
                                         API_STR2PTR(upgrade_file),
                                         &dogechat_perl_api_upgrade_read_cb,
                                         function,
                                         data);
...
dogechat_perl_api_init (pTHX)
{
    ...
    /* interface constants */
    stash = gv_stashpv ("dogechat", TRUE);
    newCONSTSUB (stash, "dogechat::DOGECHAT_RC_OK", newSViv (DOGECHAT_RC_OK));
    newCONSTSUB (stash, "dogechat::DOGECHAT_RC_OK_EAT", newSViv (DOGECHAT_RC_OK_EAT));
    newCONSTSUB (stash, "dogechat::DOGECHAT_RC_ERROR", newSViv (DOGECHAT_RC_ERROR));

    newCONSTSUB (stash, "dogechat::DOGECHAT_CONFIG_READ_OK", newSViv (DOGECHAT_CONFIG_READ_OK));
    newCONSTSUB (stash, "dogechat::DOGECHAT_CONFIG_READ_MEMORY_ERROR", newSViv (DOGECHAT_CONFIG_READ_MEMORY_ERROR));
    newCONSTSUB (stash, "dogechat::DOGECHAT_CONFIG_READ_FILE_NOT_FOUND", newSViv (DOGECHAT_CONFIG_READ_FILE_NOT_FOUND));
    newCONSTSUB (stash, "dogechat::DOGECHAT_CONFIG_WRITE_OK", newSViv (DOGECHAT_CONFIG_WRITE_OK));
    newCONSTSUB (stash, "dogechat::DOGECHAT_CONFIG_WRITE_ERROR", newSViv (DOGECHAT_CONFIG_WRITE_ERROR));
    newCONSTSUB (stash, "dogechat::DOGECHAT_CONFIG_WRITE_MEMORY_ERROR", newSViv (DOGECHAT_CONFIG_WRITE_MEMORY_ERROR));
    newCONSTSUB (stash, "dogechat::DOGECHAT_CONFIG_OPTION_SET_OK_CHANGED", newSViv (DOGECHAT_CONFIG_OPTION_SET_OK_CHANGED));
    newCONSTSUB (stash, "dogechat::DOGECHAT_CONFIG_OPTION_SET_OK_SAME_VALUE", newSViv (DOGECHAT_CONFIG_OPTION_SET_OK_SAME_VALUE));
    newCONSTSUB (stash, "dogechat::DOGECHAT_CONFIG_OPTION_SET_ERROR", newSViv (DOGECHAT_CONFIG_OPTION_SET_ERROR));
    newCONSTSUB (stash, "dogechat::DOGECHAT_CONFIG_OPTION_SET_OPTION_NOT_FOUND", newSViv (DOGECHAT_CONFIG_OPTION_SET_OPTION_NOT_FOUND));
    newCONSTSUB (stash, "dogechat::DOGECHAT_CONFIG_OPTION_UNSET_OK_NO_RESET", newSViv (DOGECHAT_CONFIG_OPTION_UNSET_OK_NO_RESET));
    newCONSTSUB (stash, "dogechat::DOGECHAT_CONFIG_OPTION_UNSET_OK_RESET", newSViv (DOGECHAT_CONFIG_OPTION_UNSET_OK_RESET));
    newCONSTSUB (stash, "dogechat::DOGECHAT_CONFIG_OPTION_UNSET_OK_REMOVED", newSViv (DOGECHAT_CONFIG_OPTION_UNSET_OK_REMOVED));
    newCONSTSUB (stash, "dogechat::DOGECHAT_CONFIG_OPTION_UNSET_ERROR", newSViv (DOGECHAT_CONFIG_OPTION_UNSET_ERROR));

    newCONSTSUB (stash, "dogechat::DOGECHAT_LIST_POS_SORT", newSVpv (DOGECHAT_LIST_POS_SORT, PL_na));
    newCONSTSUB (stash, "dogechat::DOGECHAT_LIST_POS_BEGINNING", newSVpv (DOGECHAT_LIST_POS_BEGINNING, PL_na));
    newCONSTSUB (stash, "dogechat::DOGECHAT_LIST_POS_END", newSVpv (DOGECHAT_LIST_POS_END, PL_na));

    newCONSTSUB (stash, "dogechat::DOGECHAT_HOTLIST_LOW", newSVpv (DOGECHAT_HOTLIST_LOW, PL_na));
    newCONSTSUB (stash, "dogechat::DOGECHAT_HOTLIST_MESSAGE", newSVpv (DOGECHAT_HOTLIST_MESSAGE, PL_na));
    newCONSTSUB (stash, "dogechat::DOGECHAT_HOTLIST_PRIVATE", newSVpv (DOGECHAT_HOTLIST_PRIVATE, PL_na));
    newCONSTSUB (stash, "dogechat::DOGECHAT_HOTLIST_HIGHLIGHT", newSVpv (DOGECHAT_HOTLIST_HIGHLIGHT, PL_na));

    newCONSTSUB (stash, "dogechat::DOGECHAT_HOOK_PROCESS_RUNNING", newSViv (DOGECHAT_HOOK_PROCESS_RUNNING));
    newCONSTSUB (stash, "dogechat::DOGECHAT_HOOK_PROCESS_ERROR", newSViv (DOGECHAT_HOOK_PROCESS_ERROR));

    newCONSTSUB (stash, "dogechat::DOGECHAT_HOOK_CONNECT_OK", newSViv (DOGECHAT_HOOK_CONNECT_OK));
    newCONSTSUB (stash, "dogechat::DOGECHAT_HOOK_CONNECT_ADDRESS_NOT_FOUND", newSViv (DOGECHAT_HOOK_CONNECT_ADDRESS_NOT_FOUND));
    newCONSTSUB (stash, "dogechat::DOGECHAT_HOOK_CONNECT_IP_ADDRESS_NOT_FOUND", newSViv (DOGECHAT_HOOK_CONNECT_IP_ADDRESS_NOT_FOUND));
    newCONSTSUB (stash, "dogechat::DOGECHAT_HOOK_CONNECT_CONNECTION_REFUSED", newSViv (DOGECHAT_HOOK_CONNECT_CONNECTION_REFUSED));
    newCONSTSUB (stash, "dogechat::DOGECHAT_HOOK_CONNECT_PROXY_ERROR", newSViv (DOGECHAT_HOOK_CONNECT_PROXY_ERROR));
    newCONSTSUB (stash, "dogechat::DOGECHAT_HOOK_CONNECT_LOCAL_HOSTNAME_ERROR", newSViv (DOGECHAT_HOOK_CONNECT_LOCAL_HOSTNAME_ERROR));
    newCONSTSUB (stash, "dogechat::DOGECHAT_HOOK_CONNECT_GNUTLS_INIT_ERROR", newSViv (DOGECHAT_HOOK_CONNECT_GNUTLS_INIT_ERROR));
    newCONSTSUB (stash, "dogechat::DOGECHAT_HOOK_CONNECT_GNUTLS_HANDSHAKE_ERROR", newSViv (DOGECHAT_HOOK_CONNECT_GNUTLS_HANDSHAKE_ERROR));
    newCONSTSUB (stash, "dogechat::DOGECHAT_HOOK_CONNECT_MEMORY_ERROR", newSViv (DOGECHAT_HOOK_CONNECT_MEMORY_ERROR));
    newCONSTSUB (stash, "dogechat::DOGECHAT_HOOK_CONNECT_TIMEOUT", newSViv (DOGECHAT_HOOK_CONNECT_TIMEOUT));
    newCONSTSUB (stash, "dogechat::DOGECHAT_HOOK_CONNECT_SOCKET_ERROR", newSViv (DOGECHAT_HOOK_CONNECT_SOCKET_ERROR));

    newCONSTSUB (stash, "dogechat::DOGECHAT_HOOK_SIGNAL_STRING", newSVpv (DOGECHAT_HOOK_SIGNAL_STRING, PL_na));
    newCONSTSUB (stash, "dogechat::DOGECHAT_HOOK_SIGNAL_INT", newSVpv (DOGECHAT_HOOK_SIGNAL_INT, PL_na));
    newCONSTSUB (stash, "dogechat::DOGECHAT_HOOK_SIGNAL_POINTER", newSVpv (DOGECHAT_HOOK_SIGNAL_POINTER, PL_na));
}
