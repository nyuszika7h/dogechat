...
#ifndef DOGECHAT_PERL_H
#define DOGECHAT_PERL_H 1

#define dogechat_plugin dogechat_perl_plugin
#define PERL_PLUGIN_NAME "perl"

#define PERL_CURRENT_SCRIPT_NAME ((perl_current_script) ? perl_current_script->name : "-")

extern struct t_dogechat_plugin *dogechat_perl_plugin;
...
extern HV *dogechat_perl_hashtable_to_hash (struct t_hashtable *hashtable);
extern struct t_hashtable *dogechat_perl_hash_to_hashtable (SV *hash, int size,
                                                           const char *type_keys,
                                                           const char *type_values);
extern void *dogechat_perl_exec (struct t_plugin_script *script,
                                int ret_type, const char *function,
                                const char *format, void **argv);

#endif /* DOGECHAT_PERL_H */
