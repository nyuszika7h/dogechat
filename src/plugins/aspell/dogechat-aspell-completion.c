/*
 * dogechat-aspell-completion.c - completion for aspell commands
 *
...
int
dogechat_aspell_completion_langs_cb (void *data, const char *completion_item,
...
#ifdef USE_ENCHANT
void
dogechat_aspell_completion_enchant_add_dict_cb (const char *lang_tag,
                                               ...
                                               void *user_data)
{
    ...
    dogechat_hook_completion_list_add ((struct t_gui_completion *)user_data,
                                      lang_tag, 0, DOGECHAT_LIST_POS_SORT);
}
#endif /* USE_ENCHANT */
...
int
dogechat_aspell_completion_dicts_cb (void *data,
                                    ...
                                    struct t_gui_completion *completion)
{
    ...
    enchant_broker_list_dicts (broker,
                               dogechat_aspell_completion_enchant_add_dict_cb,
                               completion);
#else
    ...
    {
        dogechat_hook_completion_list_add (completion, dict->name,
                                          0, DOGECHAT_LIST_POS_SORT);
    }
...
{
    dogechat_hook_completion ("aspell_langs",
                             N_("list of all languages supported by aspell"),
                             &dogechat_aspell_completion_langs_cb, NULL);
    dogechat_hook_completion ("aspell_dicts",
                             N_("list of aspell installed dictionaries"),
                             &dogechat_aspell_completion_dicts_cb, NULL);
}
