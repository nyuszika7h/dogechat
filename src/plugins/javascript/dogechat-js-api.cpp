/*
 * dogechat-js-api.cpp - javascript API functions
 *
...
#define API_DEF_FUNC(__name)                                            \
    dogechat_obj->Set(                                                   \
        ...
        v8::FunctionTemplate::New(dogechat_js_api_##__name));
#define API_DEF_CONST_INT(__name)                                       \
    dogechat_obj->Set(v8::String::New(#__name),                          \
...
#define API_FUNC(__name)                                                \
    ...
    dogechat_js_api_##__name(const v8::Arguments &args)
#define API_INIT_FUNC(__init, __name, __args_fmt, __ret)                \
    ...
    {                                                                   \
        DOGECHAT_SCRIPT_MSG_NOT_INIT(JS_CURRENT_SCRIPT_NAME,             \
                                    js_function_name.c_str());          \
        __ret;                                                          \
    }                                                                   \
    if (args.Length() < js_args_len)                                    \
    {                                                                   \
        DOGECHAT_SCRIPT_MSG_WRONG_ARGS(JS_CURRENT_SCRIPT_NAME,           \
                                      js_function_name.c_str());        \
        __ret;                                                          \
    }                                                                   \
...
API_FUNC(register)
{
    ...
    if (plugin_script_search (dogechat_js_plugin, js_scripts, *name))
    {
    ...
    /* register script */
    js_current_script = plugin_script_add (dogechat_js_plugin,
...
API_FUNC(plugin_get_name)
{
    ...
    result = dogechat_plugin_get_name (
        (struct t_dogechat_plugin *)API_STR2PTR(*plugin));
...
API_FUNC(string_eval_expression)
{
    ...
    pointers = dogechat_js_object_to_hashtable (
        args[1]->ToObject(),
        DOGECHAT_SCRIPT_HASHTABLE_DEFAULT_SIZE,
        DOGECHAT_HASHTABLE_STRING,
        DOGECHAT_HASHTABLE_POINTER);
    extra_vars = dogechat_js_object_to_hashtable (
        args[2]->ToObject(),
        DOGECHAT_SCRIPT_HASHTABLE_DEFAULT_SIZE,
        DOGECHAT_HASHTABLE_STRING,
        DOGECHAT_HASHTABLE_STRING);
    options = dogechat_js_object_to_hashtable (
        args[3]->ToObject(),
        DOGECHAT_SCRIPT_HASHTABLE_DEFAULT_SIZE,
        DOGECHAT_HASHTABLE_STRING,
        DOGECHAT_HASHTABLE_STRING);
...
API_FUNC(list_search)
{
    ...
    result = API_PTR2STR(
        dogechat_list_search (
            (struct t_dogelist *)API_STR2PTR(*dogelist), *data));
...
API_FUNC(list_casesearch_pos)
{
    ...
    pos = dogechat_list_casesearch_pos (
        (struct t_dogelist *)API_STR2PTR(*dogelist), *data);
...
API_FUNC(list_get)
{
    ...
    result = API_PTR2STR(
        dogechat_list_get ((struct t_dogelist *)API_STR2PTR(*dogelist),
                          position));
...
API_FUNC(list_set)
{
    ...
    dogechat_list_set ((struct t_dogelist_item *)API_STR2PTR(*item), *new_value);
...
API_FUNC(list_next)
{
    ...
    result = API_PTR2STR(
        dogechat_list_next ((struct t_dogelist_item *)API_STR2PTR(*item)));
...
API_FUNC(list_prev)
{
    ...
    result = API_PTR2STR(
        dogechat_list_prev ((struct t_dogelist_item *)API_STR2PTR(*item)));
...
API_FUNC(list_string)
{
    ...
    result = dogechat_list_string (
        (struct t_dogelist_item *)API_STR2PTR(*item));
...
API_FUNC(list_size)
{
    ...
    size = dogechat_list_size ((struct t_dogelist *)API_STR2PTR(*dogelist));
...
API_FUNC(list_remove)
{
    ...
    dogechat_list_remove ((struct t_dogelist *)API_STR2PTR(*dogelist),
                         (struct t_dogelist_item *)API_STR2PTR(*item));
...
API_FUNC(list_remove_all)
{
    ...
    dogechat_list_remove_all ((struct t_dogelist *)API_STR2PTR(*dogelist));
...
API_FUNC(list_free)
{
    ...
    dogechat_list_free ((struct t_dogelist *)API_STR2PTR(*dogelist));

    API_RETURN_OK;
}

int
dogechat_js_api_config_reload_cb (void *data, struct t_config_file *config_file)
{
...
API_FUNC(config_new)
{
    ...
    result = API_PTR2STR(
        plugin_script_api_config_new (dogechat_js_plugin,
                                      js_current_script,
                                      *name,
                                      &dogechat_js_api_config_reload_cb,
                                      *function,
                                      *data));
...
int
dogechat_js_api_config_read_cb (void *data,
...
int
dogechat_js_api_config_section_write_cb (void *data,
                                        struct t_config_file *config_file,
...
int
dogechat_js_api_config_section_write_default_cb (void *data,
                                                struct t_config_file *config_file,
                                                const char *section_name)
{
    struct t_plugin_script_cb *script_callback;
...
int
dogechat_js_api_config_section_create_option_cb (void *data,
                                                struct t_config_file *config_file,
                                                struct t_config_section *section,
...
int
dogechat_js_api_config_section_delete_option_cb (void *data,
                                                struct t_config_file *config_file,
                                                struct t_config_section *section,
    ...
    result = API_PTR2STR(
        plugin_script_api_config_new_section (
            ...
            *name,
            ...
            &dogechat_js_api_config_read_cb,
            *function_read,
            *data_read,
            &dogechat_js_api_config_section_write_cb,
            *function_write,
            *data_write,
            &dogechat_js_api_config_section_write_default_cb,
            *function_write_default,
            *data_write_default,
            &dogechat_js_api_config_section_create_option_cb,
            *function_create_option,
            *data_create_option,
            &dogechat_js_api_config_section_delete_option_cb,
...
API_FUNC(config_search_section)
{
    ...
    result = API_PTR2STR(
        dogechat_config_search_section (
            (struct t_config_file *) API_STR2PTR(*config_file),
            *section_name));
...
int
dogechat_js_api_config_option_check_value_cb (void *data,
                                             struct t_config_option *option,
                                             const char *value)
{
    struct t_plugin_script_cb *script_callback;
...
void
dogechat_js_api_config_option_change_cb (void *data,
                                        struct t_config_option *option)
{
    struct t_plugin_script_cb *script_callback;
    void *func_argv[2];
...
void
dogechat_js_api_config_option_delete_cb (void *data,
                                        struct t_config_option *option)
{
    struct t_plugin_script_cb *script_callback;
    void *func_argv[2];
...
API_FUNC(config_new_option)
{
    ...
    result = API_PTR2STR(
        plugin_script_api_config_new_option (
            ...
            *value,
            null_value_allowed,
            &dogechat_js_api_config_option_check_value_cb,
            *function_check_value,
            *data_check_value,
            &dogechat_js_api_config_option_change_cb,
            *function_change,
            *data_change,
            &dogechat_js_api_config_option_delete_cb,
            *function_delete,
            *data_delete));
...
API_FUNC(config_option_reset)
{
    ...
    rc = dogechat_config_option_reset (
...
API_FUNC(config_option_set)
{
    ...
    API_INIT_FUNC(1, "config_option_set", "ssi", API_RETURN_INT(DOGECHAT_CONFIG_OPTION_SET_ERROR));

    v8::String::Utf8Value option(args[0]);
    v8::String::Utf8Value value(args[1]);
    run_callback = args[2]->IntegerValue();

    rc = dogechat_config_option_set (
...
API_FUNC(config_option_set_null)
{
    ...
    API_INIT_FUNC(1, "config_option_set_null", "si", API_RETURN_INT(DOGECHAT_CONFIG_OPTION_SET_ERROR));

    v8::String::Utf8Value option(args[0]);
    run_callback = args[1]->IntegerValue();

    rc = dogechat_config_option_set_null (
        (struct t_config_option *)API_STR2PTR(*option), run_callback);
...
API_FUNC(config_option_unset)
{
    ...
    API_INIT_FUNC(1, "config_option_unset", "s", API_RETURN_INT(DOGECHAT_CONFIG_OPTION_UNSET_ERROR));

    v8::String::Utf8Value option(args[0]);

    rc = dogechat_config_option_unset (
...
API_FUNC(config_option_is_null)
{
    ...
    value = dogechat_config_option_is_null (
        (struct t_config_option *)API_STR2PTR(*option));
...
API_FUNC(config_option_default_is_null)
{
    ...
    value = dogechat_config_option_default_is_null (
        (struct t_config_option *)API_STR2PTR(*option));
...
API_FUNC(config_boolean_default)
{
    ...
    value = dogechat_config_boolean_default (
        (struct t_config_option *)API_STR2PTR(*option));
...
API_FUNC(config_integer_default)
{
    ...
    value = dogechat_config_integer_default (
        (struct t_config_option *)API_STR2PTR(*option));
...
API_FUNC(config_string_default)
{
    ...
    result = dogechat_config_string_default (
        (struct t_config_option *)API_STR2PTR(*option));
...
API_FUNC(config_color_default)
{
    ...
    result = dogechat_config_color_default (
        (struct t_config_option *)API_STR2PTR(*option));
...
API_FUNC(config_write)
{
    ...
    API_INIT_FUNC(1, "config_write", "s", API_RETURN_INT(DOGECHAT_CONFIG_WRITE_ERROR));

    v8::String::Utf8Value config_file(args[0]);

    rc = dogechat_config_write (
        (struct t_config_file *)API_STR2PTR(*config_file));
...
API_FUNC(config_get_plugin)
{
    ...
    result = plugin_script_api_config_get_plugin (dogechat_js_plugin,
                                                  js_current_script,
                                                  *option);
...
API_FUNC(config_is_set_plugin)
{
    ...
    rc = plugin_script_api_config_is_set_plugin (dogechat_js_plugin,
                                                 js_current_script,
                                                 *option);
...
API_FUNC(config_set_plugin)
{
    ...
    API_INIT_FUNC(1, "config_set_plugin", "ss", API_RETURN_INT(DOGECHAT_CONFIG_OPTION_SET_ERROR));

    v8::String::Utf8Value option(args[0]);
    v8::String::Utf8Value value(args[1]);

    rc = plugin_script_api_config_set_plugin (dogechat_js_plugin,
                                              js_current_script,
                                              *option,
                                              *value);
...
API_FUNC(config_set_desc_plugin)
{
    ...
    plugin_script_api_config_set_desc_plugin (dogechat_js_plugin,
                                              js_current_script,
                                              *option,
                                              *description);
...
API_FUNC(config_unset_plugin)
{
    ...
    API_INIT_FUNC(1, "config_unset_plugin", "s", API_RETURN_INT(DOGECHAT_CONFIG_OPTION_UNSET_ERROR));

    v8::String::Utf8Value option(args[0]);

    rc = plugin_script_api_config_unset_plugin (dogechat_js_plugin,
                                                js_current_script,
                                                *option);
...
API_FUNC(key_bind)
{
    ...
    hashtable = dogechat_js_object_to_hashtable (
        args[1]->ToObject(),
        DOGECHAT_SCRIPT_HASHTABLE_DEFAULT_SIZE,
        DOGECHAT_HASHTABLE_STRING,
        DOGECHAT_HASHTABLE_STRING);
...
API_FUNC(print)
{
    ...
    plugin_script_api_printf (dogechat_js_plugin,
                              js_current_script,
...
API_FUNC(print_y)
{
    ...
    plugin_script_api_printf_y (dogechat_js_plugin,
                                js_current_script,
                                (struct t_gui_buffer *)API_STR2PTR(*buffer),
                                y,
                                "%s", *message);
...
API_FUNC(log_print)
{
    ...
    plugin_script_api_log_printf (dogechat_js_plugin,
                                  js_current_script,
                                  "%s", *message);
...
int
dogechat_js_api_hook_command_cb (void *data, struct t_gui_buffer *buffer,
...
API_FUNC(hook_command)
{
    ...
    result = API_PTR2STR(
        plugin_script_api_hook_command (dogechat_js_plugin,
                                        js_current_script,
                                        *command,
                                        *description,
                                        *arguments,
                                        *args_description,
                                        *completion,
                                        &dogechat_js_api_hook_command_cb,
                                        *function,
                                        *data));
...
int
dogechat_js_api_hook_command_run_cb (void *data, struct t_gui_buffer *buffer,
                                    const char *command)
{
    struct t_plugin_script_cb *script_callback;
    void *func_argv[3];
...
API_FUNC(hook_command_run)
{
    ...
    result = API_PTR2STR(
        plugin_script_api_hook_command_run (
            ...
            js_current_script,
            *command,
            &dogechat_js_api_hook_command_run_cb,
            *function,
            *data));
...
int
dogechat_js_api_hook_timer_cb (void *data, int remaining_calls)
{
    struct t_plugin_script_cb *script_callback;
    void *func_argv[2];
...
int
dogechat_js_api_hook_fd_cb (void *data, int fd)
{
    struct t_plugin_script_cb *script_callback;
    void *func_argv[2];
...
int
dogechat_js_api_hook_process_cb (void *data,
...
API_FUNC(hook_process)
{
    ...
    result = API_PTR2STR(
        plugin_script_api_hook_process (
            ...
            *command,
            timeout,
            &dogechat_js_api_hook_process_cb,
            *function,
            *data));
...
int
dogechat_js_api_hook_connect_cb (void *data, int status, int gnutls_rc,
...
API_FUNC(hook_connect)
{
    ...
    result = API_PTR2STR(
        plugin_script_api_hook_connect (
            ...
            *local_hostname,
            &dogechat_js_api_hook_connect_cb,
            *function,
            *data));
...
int
dogechat_js_api_hook_print_cb (void *data, struct t_gui_buffer *buffer,
                              time_t date,
...
int
dogechat_js_api_hook_signal_cb (void *data, const char *signal,
...
API_FUNC(hook_signal)
{
    ...
    result = API_PTR2STR(
        plugin_script_api_hook_signal (
            ...
            js_current_script,
            *signal,
            &dogechat_js_api_hook_signal_cb,
            *function,
            *data));
...
API_FUNC(hook_signal_send)
{
    ...
    API_INIT_FUNC(1, "hook_signal_send", "sss", API_RETURN_INT(DOGECHAT_RC_ERROR));
...
int
dogechat_js_api_hook_hsignal_cb (void *data, const char *signal,
                                struct t_hashtable *hashtable)
{
    struct t_plugin_script_cb *script_callback;
    void *func_argv[3];
...
API_FUNC(hook_hsignal)
{
    ...
    result = API_PTR2STR(
        plugin_script_api_hook_hsignal (
            ...
            js_current_script,
            *signal,
            &dogechat_js_api_hook_hsignal_cb,
            *function,
            *data));
...
API_FUNC(hook_hsignal_send)
{
    ...
    API_INIT_FUNC(1, "hook_hsignal_send", "sh", API_RETURN_INT(DOGECHAT_RC_ERROR));
...
int
dogechat_js_api_hook_config_cb (void *data, const char *option,
                               const char *value)
{
    struct t_plugin_script_cb *script_callback;
    void *func_argv[3];
...
API_FUNC(hook_config)
{
    ...
    result = API_PTR2STR(
        plugin_script_api_hook_config (
            ...
            js_current_script,
            *option,
            &dogechat_js_api_hook_config_cb,
            *function,
            *data));
...
int
dogechat_js_api_hook_completion_cb (void *data, const char *completion_item,
...
API_FUNC(hook_completion)
{
    ...
    result = API_PTR2STR(
        plugin_script_api_hook_completion (
            ...
            *completion,
            *description,
            &dogechat_js_api_hook_completion_cb,
            *function,
            *data));
...
char *
dogechat_js_api_hook_modifier_cb (void *data, const char *modifier,
...
API_FUNC(hook_modifier)
{
    ...
    result = API_PTR2STR(
        plugin_script_api_hook_modifier (
            ...
            js_current_script,
            *modifier,
            &dogechat_js_api_hook_modifier_cb,
            *function,
            *data));
...
const char *
dogechat_js_api_hook_info_cb (void *data, const char *info_name,
                             const char *arguments)
{
    ...
    if (script_callback && script_callback->function && script_callback->function[0])
    {
        ...
        return (const char *)dogechat_js_exec (
            (struct t_plugin_script *)script_callback->script,
            DOGECHAT_SCRIPT_EXEC_STRING,
            script_callback->function,
            "sss", func_argv);
...
struct t_hashtable *
dogechat_js_api_hook_info_hashtable_cb (void *data, const char *info_name,
                                       struct t_hashtable *hashtable)
{
    struct t_plugin_script_cb *script_callback;
    void *func_argv[3];
    ...
    if (script_callback && script_callback->function && script_callback->function[0])
    {
        ...
        ret_hashtable = (struct t_hashtable *)dogechat_js_exec (
            (struct t_plugin_script *)script_callback->script,
...
API_FUNC(hook_info_hashtable)
{
    ...
    result = API_PTR2STR(
        plugin_script_api_hook_info_hashtable (
            ...
            *args_description,
            *output_description,
            &dogechat_js_api_hook_info_hashtable_cb,
            *function,
            *data));
...
struct t_infolist *
dogechat_js_api_hook_infolist_cb (void *data, const char *infolist_name,
                                 void *pointer, const char *arguments)
{
    ...
    if (script_callback && script_callback->function && script_callback->function[0])
    {
        ...
        result = (struct t_infolist *)dogechat_js_exec (
            (struct t_plugin_script *)script_callback->script,
            DOGECHAT_SCRIPT_EXEC_STRING,
            script_callback->function,
            "ssss", func_argv);
...
API_FUNC(hook_infolist)
{
    ...
    result = API_PTR2STR(
        plugin_script_api_hook_infolist (
            ...
            *pointer_description,
            *args_description,
            &dogechat_js_api_hook_infolist_cb,
            *function,
            *data));
...
struct t_hashtable *
dogechat_js_api_hook_focus_cb (void *data,
...
API_FUNC(hook_set)
{
    ...
    dogechat_hook_set ((struct t_hook *)API_STR2PTR(*hook), *property, *value);
...
API_FUNC(unhook)
{
    ...
    plugin_script_api_unhook (dogechat_js_plugin,
                              js_current_script,
...
API_FUNC(unhook_all)
{
    ...
    plugin_script_api_unhook_all (dogechat_js_plugin, js_current_script);

    API_RETURN_OK;
}

int
dogechat_js_api_buffer_input_data_cb (void *data, struct t_gui_buffer *buffer,
...
int
dogechat_js_api_buffer_close_cb (void *data, struct t_gui_buffer *buffer)
{
    struct t_plugin_script_cb *script_callback;
    void *func_argv[2];
    char empty_arg[1] = { '\0' };
...
API_FUNC(buffer_clear)
{
    ...
    dogechat_buffer_clear ((struct t_gui_buffer *)API_STR2PTR(*buffer));
...
API_FUNC(buffer_merge)
{
    ...
    dogechat_buffer_merge ((struct t_gui_buffer *)API_STR2PTR(*buffer),
...
API_FUNC(buffer_unmerge)
{
    ...
    dogechat_buffer_unmerge ((struct t_gui_buffer *)API_STR2PTR(*buffer),
                            number);
...
API_FUNC(buffer_get_integer)
{
    ...
    value = dogechat_buffer_get_integer (
        (struct t_gui_buffer *)API_STR2PTR(*buffer),
        *property);
...
API_FUNC(buffer_get_string)
{
    ...
    result = dogechat_buffer_get_string (
        (struct t_gui_buffer *)API_STR2PTR(*buffer),
        *property);
...
API_FUNC(buffer_string_replace_local_var)
{
    ...
    result = dogechat_buffer_string_replace_local_var (
        (struct t_gui_buffer *)API_STR2PTR(*buffer),
        *string);
...
API_FUNC(buffer_match_list)
{
    ...
    value = dogechat_buffer_match_list (
        (struct t_gui_buffer *)API_STR2PTR(*buffer),
        *string);
...
API_FUNC(window_search_with_buffer)
{
    ...
    result = API_PTR2STR(
        dogechat_window_search_with_buffer (
            (struct t_gui_buffer *)API_STR2PTR(*buffer)));
...
API_FUNC(window_get_integer)
{
    ...
    value = dogechat_window_get_integer (
...
API_FUNC(window_get_string)
{
    ...
    result = dogechat_window_get_string (
        (struct t_gui_window *)API_STR2PTR(*window),
        *property);
...
API_FUNC(nicklist_search_group)
{
    ...
    result = API_PTR2STR(
        dogechat_nicklist_search_group (
            (struct t_gui_buffer *)API_STR2PTR(*buffer),
...
API_FUNC(nicklist_remove_group)
{
    ...
    dogechat_nicklist_remove_group (
            (struct t_gui_buffer *)API_STR2PTR(*buffer),
            (struct t_gui_nick_group *)API_STR2PTR(*group));
...
API_FUNC(nicklist_remove_all)
{
    ...
    dogechat_nicklist_remove_all ((struct t_gui_buffer *)API_STR2PTR(*buffer));
...
API_FUNC(nicklist_group_get_integer)
{
    ...
    value = dogechat_nicklist_group_get_integer (
        (struct t_gui_buffer *)API_STR2PTR(*buffer),
        (struct t_gui_nick_group *)API_STR2PTR(*group),
        *property);
...
API_FUNC(nicklist_group_get_string)
{
    ...
    result = dogechat_nicklist_group_get_string (
        (struct t_gui_buffer *)API_STR2PTR(*buffer),
        (struct t_gui_nick_group *)API_STR2PTR(*group),
        *property);
...
API_FUNC(nicklist_group_get_pointer)
{
    ...
    result = API_PTR2STR(
        dogechat_nicklist_group_get_pointer (
            (struct t_gui_buffer *)API_STR2PTR(*buffer),
            (struct t_gui_nick_group *)API_STR2PTR(*group),
            *property));
...
API_FUNC(nicklist_nick_get_integer)
{
    ...
    value = dogechat_nicklist_nick_get_integer (
        (struct t_gui_buffer *)API_STR2PTR(*buffer),
        (struct t_gui_nick *)API_STR2PTR(*nick),
        *property);
...
API_FUNC(nicklist_nick_get_string)
{
    ...
    result = dogechat_nicklist_nick_get_string (
        (struct t_gui_buffer *)API_STR2PTR(*buffer),
        (struct t_gui_nick *)API_STR2PTR(*nick),
        *property);
...
API_FUNC(nicklist_nick_get_pointer)
{
    ...
    result = API_PTR2STR(
        dogechat_nicklist_nick_get_pointer (
            (struct t_gui_buffer *)API_STR2PTR(*buffer),
            (struct t_gui_nick *)API_STR2PTR(*nick),
            *property));
...
char *
dogechat_js_api_bar_item_build_cb (void *data, struct t_gui_bar_item *item,
...
API_FUNC(bar_item_new)
{
    ...
    result = API_PTR2STR(
        plugin_script_api_bar_item_new (
            ...
            js_current_script,
            *name,
            &dogechat_js_api_bar_item_build_cb,
            *function,
            *data));
...
API_FUNC(bar_remove)
{
    ...
    dogechat_bar_remove ((struct t_gui_bar *)API_STR2PTR(*bar));
...
API_FUNC(command)
{
    ...
    API_INIT_FUNC(1, "command", "ss", API_RETURN_INT(DOGECHAT_RC_ERROR));

    v8::String::Utf8Value buffer(args[0]);
    v8::String::Utf8Value command(args[1]);

    rc = plugin_script_api_command (dogechat_js_plugin,
                                    js_current_script,
                                    (struct t_gui_buffer *)API_STR2PTR(*buffer),
                                    *command);
...
API_FUNC(info_get_hashtable)
{
    ...
    result_obj = dogechat_js_hashtable_to_object (
        result_hashtable);
...
API_FUNC(infolist_new_var_integer)
{
    ...
    result = API_PTR2STR(
        dogechat_infolist_new_var_integer (
...
API_FUNC(infolist_new_var_string)
{
    ...
    result = API_PTR2STR(
        dogechat_infolist_new_var_string (
            (struct t_infolist_item *)API_STR2PTR(*item),
            *name,
            *value));
...
API_FUNC(infolist_new_var_pointer)
{
    ...
    result = API_PTR2STR(
        dogechat_infolist_new_var_pointer (
            (struct t_infolist_item *)API_STR2PTR(*item),
            *name,
            API_STR2PTR(*value)));
...
API_FUNC(infolist_new_var_time)
{
    ...
    result = API_PTR2STR(
        dogechat_infolist_new_var_time (
            (struct t_infolist_item *)API_STR2PTR(*item),
            *name,
            value));
...
API_FUNC(infolist_reset_item_cursor)
{
    ...
    dogechat_infolist_reset_item_cursor (
        (struct t_infolist *)API_STR2PTR(*infolist));
...
API_FUNC(infolist_fields)
{
    ...
    result = dogechat_infolist_fields (
        (struct t_infolist *)API_STR2PTR(*infolist));
...
API_FUNC(infolist_integer)
{
    ...
    value = dogechat_infolist_integer (
        (struct t_infolist *)API_STR2PTR(*infolist),
        *variable);
...
API_FUNC(infolist_string)
{
    ...
    result = dogechat_infolist_string (
        (struct t_infolist *)API_STR2PTR(*infolist),
        *variable);
...
API_FUNC(infolist_free)
{
    ...
    dogechat_infolist_free ((struct t_infolist *)API_STR2PTR(*infolist));
...
API_FUNC(hdata_get_var_offset)
{
    ...
    value = dogechat_hdata_get_var_offset (
...
API_FUNC(hdata_get_var_type_string)
{
    ...
    result = dogechat_hdata_get_var_type_string (
        (struct t_hdata *)API_STR2PTR(*hdata),
        *name);
...
API_FUNC(hdata_get_var_array_size)
{
    ...
    value = dogechat_hdata_get_var_array_size (
        (struct t_hdata *)API_STR2PTR(*hdata),
        API_STR2PTR(*pointer),
        *name);
...
API_FUNC(hdata_get_var_array_size_string)
{
    ...
    result = dogechat_hdata_get_var_array_size_string (
        (struct t_hdata *)API_STR2PTR(*hdata),
        API_STR2PTR(*pointer),
        *name);
...
API_FUNC(hdata_get_var_hdata)
{
    ...
    result = dogechat_hdata_get_var_hdata (
        (struct t_hdata *)API_STR2PTR(*hdata),
        *name);
...
API_FUNC(hdata_check_pointer)
{
    ...
    value = dogechat_hdata_check_pointer (
        (struct t_hdata *)API_STR2PTR(*hdata),
        API_STR2PTR(*list),
        API_STR2PTR(*pointer));
...
API_FUNC(hdata_get_string)
{
    ...
    result = dogechat_hdata_get_string (
        (struct t_hdata *)API_STR2PTR(*hdata),
        *property);
...
API_FUNC(upgrade_write_object)
{
    ...
    rc = dogechat_upgrade_write_object (
...
int
dogechat_js_api_upgrade_read_cb (void *data,
...
API_FUNC(upgrade_read)
{
    ...
    rc = plugin_script_api_upgrade_read (
        ...
        js_current_script,
        (struct t_upgrade_file *)API_STR2PTR(*upgrade_file),
        &dogechat_js_api_upgrade_read_cb,
        *function,
        *data);
...
void
DogechatJsV8::loadLibs()
{
    v8::Local<v8::ObjectTemplate> dogechat_obj = v8::ObjectTemplate::New();
    ...
    this->addGlobal ("dogechat", dogechat_obj);
}
