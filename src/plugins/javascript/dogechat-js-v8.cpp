/*
 * dogechat-js-v8.cpp - v8 javascript functions
 *
...
#define PRINT_EXCEPTION                                                 \
    ...
    dogechat_printf (NULL,                                               \
                    dogechat_gettext ("%s%s: exception: %s"),            \
...
bool
DogechatJsV8::load(Handle<String> source)
{
    this->source = source;
...
bool
DogechatJsV8::load(const char *source)
{
...
bool
DogechatJsV8::functionExists(const char *function)
{
    Context::Scope context_scope(this->context);
...
Handle<Value>
DogechatJsV8::execFunction(const char *function, int argc, Handle<Value> *argv)
{
    v8::TryCatch trycatch;
...
void
DogechatJsV8::addGlobal(Handle<String> key, Handle<Template> val)
{
...
void
DogechatJsV8::addGlobal(const char *key, Handle<Template> val)
{
