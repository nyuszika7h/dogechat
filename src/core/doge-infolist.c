/*
 * doge-infolist.c - info lists management
 *
...
struct t_infolist *dogechat_infolists = NULL;
struct t_infolist *last_dogechat_infolist = NULL;
...
struct t_infolist *
infolist_new (struct t_dogechat_plugin *plugin)
{
    ...
    if (new_infolist)
    {
        ...
        new_infolist->prev_infolist = last_dogechat_infolist;
        new_infolist->next_infolist = NULL;
        if (dogechat_infolists)
            last_dogechat_infolist->next_infolist = new_infolist;
        else
            dogechat_infolists = new_infolist;
        last_dogechat_infolist = new_infolist;
    }
...
{
    struct t_infolist *new_dogechat_infolists;

    /* remove list */
    if (last_dogechat_infolist == infolist)
        last_dogechat_infolist = infolist->prev_infolist;
    if (infolist->prev_infolist)
    {
        (infolist->prev_infolist)->next_infolist = infolist->next_infolist;
        new_dogechat_infolists = dogechat_infolists;
    }
    else
        new_dogechat_infolists = infolist->next_infolist;
    ...
    dogechat_infolists = new_dogechat_infolists;
}
...
void
infolist_free_all_plugin (struct t_dogechat_plugin *plugin)
{
    struct t_infolist *ptr_infolist, *next_infolist;

    ptr_infolist = dogechat_infolists;
    while (ptr_infolist)
    {
...
/*
 * Prints infolists in DogeChat log file (usually for crash dump).
 */
