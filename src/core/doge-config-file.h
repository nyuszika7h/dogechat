...
#ifndef DOGECHAT_CONFIG_FILE_H
#define DOGECHAT_CONFIG_FILE_H 1
...
{
    struct t_dogechat_plugin *plugin;       /* plugin which created this cfg */
    char *name;                            /* name (example: "dogechat")     */
    char *filename;                        /* filename (without path)       */
                                           /* (example: "dogechat.conf")     */
...
extern struct t_config_file *config_file_new (struct t_dogechat_plugin *plugin,
                                              const char *name,
...
extern void config_file_free_all_plugin (struct t_dogechat_plugin *plugin);
