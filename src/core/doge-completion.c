/*
 * doge-completion.c - completion for DogeChat commands
 *
                               ...
                               struct t_gui_completion *completion)
{
    ...
    num_colors = gui_color_get_dogechat_colors_number ();
                                 ...
                                 struct t_gui_completion *completion)
{
    ...
    else
    {
        ...
        {
            real_prefix = strdup (dogechat_home);
            prefix = strdup ("");
        }
        else
        {
                              ...
                              struct t_gui_completion *completion)
{
    ...
    for (ptr_hook = dogechat_hooks[HOOK_TYPE_INFO]; ptr_hook;
         ptr_hook = ptr_hook->next_hook)
    {
        if (!ptr_hook->deleted
                                  ...
                                  struct t_gui_completion *completion)
{
    ...
    for (ptr_hook = dogechat_hooks[HOOK_TYPE_INFOLIST]; ptr_hook;
         ptr_hook = ptr_hook->next_hook)
    {
        if (!ptr_hook->deleted
...
completion_list_add_plugins_installed_exec_cb (void *data, const char *filename)
{
    ...
    if (name)
    {
        gui_completion_list_add (completion, name, 0, DOGECHAT_LIST_POS_SORT);
        free (name);
    }
}
                                          ...
                                          struct t_gui_completion *completion)
{
    ...
    /* plugins in DogeChat global lib dir */
...
/*
 * Adds DogeChat commands to completion list.
 */

int
completion_list_add_dogechat_commands_cb (void *data,
                                         const char *completion_item,
                                         struct t_gui_buffer *buffer,
                                         struct t_gui_completion *completion)
{
                                     ...
                                     struct t_gui_completion *completion)
{
    ...
    gui_completion_list_add (completion, "chat", 0, DOGECHAT_LIST_POS_SORT);
...
/*
 * Adds hooks for completions done by DogeChat core.
 */
...
completion_init ()
{
    ...
    hook_completion (NULL, "commands", /* formerly "%h" */
                     N_("commands (dogechat and plugins)"),
    ...
    hook_completion (NULL, "dogechat_commands", /* formerly "%w" */
                     N_("dogechat commands"),
                     &completion_list_add_dogechat_commands_cb, NULL);
