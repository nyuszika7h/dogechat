...
#ifndef DOGECHAT_HDATA_H
#define DOGECHAT_HDATA_H 1
...
struct t_hdata
{
    ...
    struct t_dogechat_plugin *plugin;   /* plugin which created this hdata   */
...
extern struct t_hashtable *dogechat_hdata;

extern char *hdata_type_string[];

extern struct t_hdata *hdata_new (struct t_dogechat_plugin *plugin,
