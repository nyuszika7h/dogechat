...
/*
 * Returns the package name ("dogechat") + DogeChat version.
 *
 * Examples:
 *   dogechat 0.3.9-dev
 *   dogechat 0.3.9-rc1
...
/*
 * Returns the DogeChat version + the git version (between brackets, and only if
 * it is not empty).
 *
 * Examples:
...
/*
 * Returns date of DogeChat compilation.
 *
 * Example:
 *   Dec 16 2012
 */
...
/*
 * Returns time of DogeChat compilation.
 *
 * Example:
 *   18:10:22
 */
