/*
 * doge-input.c - default input callback for buffers
 *
 ...
 *
 * Returns:
 *   DOGECHAT_RC_OK: command executed
 *   DOGECHAT_RC_ERROR: error, command not executed
 */
 ...
 *
 * Returns:
 *   DOGECHAT_RC_OK: data properly sent (or command executed successfully)
 *   DOGECHAT_RC_ERROR: error
 */
