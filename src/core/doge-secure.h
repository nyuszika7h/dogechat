...
#ifndef DOGECHAT_SECURE_H
#define DOGECHAT_SECURE_H 1

#define SECURE_CONFIG_NAME "sec"

#define SECURE_ENV_PASSPHRASE       "DOGECHAT_PASSPHRASE"
#define SECURE_SALT_DEFAULT         "DogeChat!"
