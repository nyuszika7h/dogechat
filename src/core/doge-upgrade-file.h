...
#ifndef DOGECHAT_UPGRADE_FILE_H
#define DOGECHAT_UPGRADE_FILE_H 1

#define UPGRADE_SIGNATURE "===== DogeChat Upgrade file v2.2 - binary, do not edit! ====="
