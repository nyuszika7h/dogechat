...
#ifndef DOGECHAT_CONFIG_H
#define DOGECHAT_CONFIG_H 1
...
#define DOGECHAT_CONFIG_NAME "dogechat"
...
extern struct t_config_file *dogechat_config_file;
extern struct t_config_section *dogechat_config_section_color;
extern struct t_config_section *dogechat_config_section_proxy;
extern struct t_config_section *dogechat_config_section_bar;
extern struct t_config_section *dogechat_config_section_notify;
...
extern struct t_config_option *config_dogechat_debug_get (const char *plugin_name);
extern int config_dogechat_debug_set (const char *plugin_name,
                                     const char *value);
extern void config_dogechat_debug_set_all ();
extern int config_dogechat_notify_set (struct t_gui_buffer *buffer,
                                      const char *notify);
extern int config_dogechat_init ();
extern int config_dogechat_read ();
extern int config_dogechat_write ();
extern void config_dogechat_free ();

#endif /* DOGECHAT_CONFIG_H */
