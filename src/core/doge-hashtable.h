...
#ifndef DOGECHAT_HASHTABLE_H
#define DOGECHAT_HASHTABLE_H 1
 ...
 * "dogechat", "fast", "light", "extensible", "chat", "client"
...
struct t_dogelist *hashtable_get_list_keys (struct t_hashtable *hashtable);
