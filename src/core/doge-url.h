...
#ifndef DOGECHAT_URL_H
#define DOGECHAT_URL_H 1
...
extern int dogeurl_download (const char *url, struct t_hashtable *options);
extern int dogeurl_option_add_to_infolist (struct t_infolist *infolist,
                                          struct t_url_option *option);

#endif /* DOGECHAT_URL_H */
