...
#ifndef DOGECHAT_INFOLIST_H
#define DOGECHAT_INFOLIST_H 1
...
struct t_infolist
{
    struct t_dogechat_plugin *plugin;   /* plugin which created this infolist*/
                                       /* (NULL if created by DogeChat)      */
...
extern struct t_infolist *dogechat_infolists;
extern struct t_infolist *last_dogechat_infolist;

/* list functions */

extern struct t_infolist *infolist_new (struct t_dogechat_plugin *plugin);
...
extern void infolist_free_all_plugin (struct t_dogechat_plugin *plugin);
extern void infolist_print_log ();

#endif /* DOGECHAT_INFOLIST_H */
