...
#ifndef DOGECHAT_PROXY_H
#define DOGECHAT_PROXY_H 1
...
extern struct t_proxy *dogechat_proxies;
extern struct t_proxy *last_dogechat_proxy;
extern struct t_proxy *dogechat_temp_proxies;
extern struct t_proxy *last_dogechat_temp_proxy;
