/*
 * doge-utf8.c - UTF-8 string functions
 *
...
/*
 * Initializes UTF-8 in DogeChat.
 */

void
utf8_init ()
{
    local_utf8 = (string_strcasecmp (dogechat_local_charset, "UTF-8") == 0);
}
...
utf8_pos (const char *string, int real_pos)
{
    ...
    if (!string || !dogechat_local_charset)
        return real_pos;
