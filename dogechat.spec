...
Version:   %{version}
Release:   %{release}
Source:    https://dogechat.org/files/src/%{name}-%{version}.tar.gz
URL:       https://dogechat.org/
...
%description
DogeChat (Doge Enhanced Environment for Chat) is a portable, fast, light and
...
%{_libdir}/pkgconfig/dogechat.pc
%{_includedir}/%{name}/dogechat-plugin.h
%{_prefix}/share/icons/hicolor/32x32/apps/dogechat.png
